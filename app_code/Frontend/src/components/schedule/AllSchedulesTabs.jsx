...
function AllSchedules(){
    ...
    return(
        <div className="mx-5 home-container">
            ...
            <div>
                <Button className={button0} onClick={()=>camHor0()} style={{marginRight:"10px"}}>0 años</Button>
                <Button className={button1} onClick={()=>camHor1()} style={{marginRight:"10px"}}>1 año</Button>
                <Button className={button2} onClick={()=>camHor2()} style={{marginRight:"10px"}}>2-3 años</Button>
            </div>
