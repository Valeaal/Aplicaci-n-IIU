    ...
    <table className="table table-bordered">
      ...
      <tbody>   
        ...
        <tr className="table-warning">
          ...
          <td className="text-center align-middle">Aseo / Relajación</td>
        </tr>
        <tr className="table-info">
          <th scope="row" className="text-center align-middle">10:15-11:00</th>
          <td className="text-center align-middle">Actividades educativas</td>
        </tr>
        <tr className="table-warning">
          <th scope="row" className="text-center align-middle">11:00-12:00</th>
          <td className="text-center align-middle">Patio de juego / Aseo</td>
        </tr>
        <tr className="table-info">
        ...
        <tr className="table-info">
          ...
          <td className="text-center align-middle">Juegos sonoros / Aseo / Salida</td>
        </tr>
      </tbody>
    </table>
  );
