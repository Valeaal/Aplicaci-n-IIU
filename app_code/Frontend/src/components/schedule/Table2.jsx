  ...
  return (
    <table className="table table-bordered">
      <thead className="table-warning text-center">
        <tr>
          <th tabIndex={0} scope="col" className="text-center align-middle">FRANJAS HORARIAS</th>
          <th tabIndex={0} scope="col" className="text-center align-middle">ACTIVIDAD</th>
        </tr>
      </thead>
      <tbody>
        ...
        <tr className="table-warning">
          ...
          <td tabIndex={0} className="text-center align-middle">Juegos manipulativos</td>
        </tr>
        <tr className="table-info">
          <th tabIndex={0} scope="row" className="text-center align-middle">10:15-11:00</th>
          <td tabIndex={0} className="text-center align-middle">Actividades en el aula</td>
        </tr>
        <tr className="table-warning">
          <th tabIndex={0} scope="row" className="text-center align-middle">11:00-12:00</th>
          <td tabIndex={0} className="text-center align-middle">Recreo</td>
        </tr>
        <tr className="table-info">
          <th tabIndex={0} scope="row" className="text-center align-middle">12:30-13:00</th>
          <td tabIndex={0} className="text-center align-middle">Aseo / Almuerzo</td>
        </tr>
        <tr className="table-warning">
        ...
        <tr className="table-info">
          ...
          <td tabIndex={0} className="text-center align-middle">Juegos / Visionado de DVD / Musica / Aseo / Salida</td>
        </tr>
      </tbody>
    </table>
  );
